...
The backport targets vendored OpenThread revision `a12ff0d0f54fd41954b45047fcdd08f302731c5f`. Its Fast Attach portion retains the documented adjustments of the existing isolated `fast-attach` variant; this combined variant adds only selected-parent arming, the LQ3 acceptance gate for the directed response, actual-unicast effective responder selection, and diagnostic logging.
